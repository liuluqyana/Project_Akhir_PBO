...
public class PemesananModel {
    // [OOP: Encapsulation] Semua atribut dideklarasikan sebagai private (Data Hiding)
    // Hal ini mencegah class luar mengubah isi data log transaksi pemesanan secara langsung
    ...
    // [OOP: Encapsulation] Method Accessor (Getter) untuk membaca nilai properti secara aman
    public String getIdPesan()          { return idPesan; }
    // [OOP: Encapsulation] Method Mutator (Setter) sebagai satu-satunya gerbang untuk mengisi/mengubah data
